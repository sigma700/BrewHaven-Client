...
// In your FullMenu.js component, you might want to add these improvements:
  ...
  return (
    ...
    >
      <motion.button
        ...
        initial={false}
        className="relative h-12 w-12 rounded-full bg-amber-800 shadow-lg border border-amber-700 z-50 flex items-center justify-center"
